...
export default function Home() {
  return (
    <div className="animate-in fade-in duration-500 bg-white">
      ...
      {/* 1. HERO SECTION (Light & Airy) - Desktop & Mobile Optimized Whitespace */}
      <section className="bg-brand-light pt-28 md:pt-32 pb-12 md:pb-16 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 md:gap-12 items-center relative z-10">
          ...
          {/* Reduced the extra padding here to pull the text up */}
          <div className="pt-2 md:pt-4">
            {/* The exact text requested by the client */}
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold mb-4 md:mb-6 leading-tight text-brand-dark">
              ...
              <span className="text-brand-blue relative">
                ...
                <svg 
                  className="absolute w-full h-2 md:h-3 -bottom-1 left-0 text-brand-yellow opacity-70" 
                  viewBox="0 0 100 10" 
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                to="/contact" 
                className="bg-brand-blue text-white px-6 md:px-8 py-3 md:py-4 rounded-xl font-bold hover:bg-blue-700 transition flex items-center gap-2 shadow-lg shadow-blue-500/30"
              >
          ...
          <div className="relative mt-8 lg:mt-0">
            {/* Illustration/Image Card with floating elements */}
            ...
            <div 
              className="absolute -bottom-4 -left-4 md:-bottom-6 md:-left-6 bg-white p-3 md:p-5 rounded-2xl shadow-xl flex items-center gap-3 md:gap-4 border border-slate-50 animate-bounce" 
            ...
            >
              ...
              <div>
                <p className="font-extrabold text-lg md:text-xl text-brand-dark">
                  10+ Years
                </p>
      ...
      {/* 2. STATS BAR (Using our Custom Animation) */}
      ...
      <section className="py-24 px-4 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h3 className="text-3xl md:text-5xl font-extrabold text-brand-dark mb-6">
            Comprehensive Education
          </h3>

          <p className="text-slate-600 text-lg">
            We provide tailored learning experiences to suit every student's unique requirements in Bhilai.
          </p>
        </div>
          ...
          {[
            {
              icon: <Users size={32} />,
              title: "Home Tuition",
              desc: "One-on-one personalized learning at the comfort of your home for maximum focus.",
            },
            {
              icon: <MonitorPlay size={32} />,
              title: "Classroom Coaching",
              desc: "Interactive group classes focusing on peer learning and competitive spirit.",
            },
            {
              icon: <BookOpen size={32} />,
              title: "Board Exam Prep",
              desc: "Specialized crash courses and test series for CBSE, ICSE, and State Boards.",
            },
          ].map((service, i) => (
            <div
              key={i}
              className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-blue-100 transition duration-300 group"
            >
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-slate-600 mb-10 text-lg leading-relaxed">
              We believe that every student has immense potential. Our goal is to unlock that potential through dedicated mentorship and a proven curriculum.
            </p>
              ...
              {[
                {
                  ...
                  desc: "No rote learning. We focus on deep understanding.",
                },
                {
                  title: "Weekly Assessments",
                  desc: "Regular tests to track progress and identify weak areas.",
                },
                {
                  title: "24/7 Doubt Clearing",
                  desc: "Students can reach out to tutors anytime via our portal.",
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="flex gap-5 bg-white p-5 rounded-2xl shadow-sm border border-slate-50"
                >
                  <div className="mt-1">
                    <CheckCircle className="text-brand-yellow" size={28} />
                  </div>

                  <div>
                    <h4 className="text-xl font-bold text-brand-dark mb-1">
                      {item.title}
                    </h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 auto-rows-[250px]">
            ...
            <div className="overflow-hidden rounded-3xl shadow-lg">
              <img
                src="https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?auto=format&fit=crop&w=500&q=80"
                alt="Students"
                className="w-full h-full object-cover hover:scale-105 transition duration-700"
              />
            </div>
      ...
      {/* 6. BOTTOM CTA */}
      <section className="py-24 px-4 bg-brand-light">
        <div className="max-w-5xl mx-auto text-center bg-brand-blue rounded-3xl p-16 shadow-2xl relative overflow-hidden">
          ...
          <p className="text-blue-100 mb-10 text-xl max-w-2xl mx-auto relative z-10">
            Join thousands of successful students in Bhilai. Enroll today and experience the difference in your learning journey.
          </p>

          <Link
            to="/contact"
            className="inline-block bg-brand-yellow text-brand-dark px-10 py-4 rounded-xl font-extrabold text-lg hover:bg-white hover:text-brand-blue transition-all shadow-xl relative z-10"
          >
            Schedule a Callback
          </Link>
        </div>
